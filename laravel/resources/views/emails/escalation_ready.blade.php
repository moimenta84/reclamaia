...
<p>ReclamaIA ha generado automáticamente una <strong>carta de escalada formal</strong> dirigida a:</p>
<ul>
...
<p style="color: #888; font-size: 12px; margin-top: 20px;">ReclamaIA · Este servicio es automático y gratuito para usuarios registrados.</p>
</body>
</html>
